https://discordapp.com/channels/338404537931137024/338615554531131392'use strict';

const EventEmitter = require("events"),
https = require("https"),
{request: hRequest} = require("async_helpers");
...
APIAccount.getToken = async function getToken(pass) {
	return JSON.parse((await request(null, "get_token", {pass: pass})).data)
}

module.exports.APIAccount = APIAccount;
